...
KRON_UPS_Debug = if groo_param_editmode then {1} else {0};
...
KRON_UPS_Res_enemy = [west,east]; //dependent on mission settings! ToDo: make this param auto sensing
...
R_USE_SMOKE_wounded = 10; // org 13: decreased while AI is popping smoke a bit too often
...
KRON_UPS_ARTILLERY_EAST_FIRE = true; //set to true for doing east to fire //ToDo verify if needed
